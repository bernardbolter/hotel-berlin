...
import { SCAFFOLD_PATHNAME, SCAFFOLD_RELATED } from '@/lib/scaffolds/catalog'
...
export async function AmenitiesPageView({ locale }: Props) {
  ...
  const related = SCAFFOLD_RELATED.amenities
  const copy = {
      ...
      <main id="main-content" className="bg-hbb-page">
        <div className="site-shell px-section-sm py-section-y md:px-section-x">
          <header className="mb-10 max-w-3xl">
            ...
            <p className="mt-4 font-serif text-serif-sm text-[#2A3540]">
          ...
          {related.length > 0 ? (
            <nav aria-label={t('relatedAria')} className="mt-12 max-w-3xl">
