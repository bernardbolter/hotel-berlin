/**
 * Baseline schema for empty databases (Neon production / preview).
 * Do not run this against a local DB that was built with Drizzle push — tables
 * already exist. Those DBs keep the `dev` / batch -1 row and continue using push
