...
export const footerSeedEn = {
  ...
  columns: [
    {
      ...
      links: [
        ...
        link('Check-in / Check-out', '/policies/check-in', { dividerBefore: true }),
        link('Cancellations', '/policies/cancellation'),
        link('Pets', '/policies/pets'),
      ],
    },
    {
      ...
      links: [
        ...
        link('On the Walls', '/on-the-walls', { dividerBefore: true }),
  ...
  legalLinks: [
    ...
    { visible: true, label: 'Disclaimer', url: '/disclaimer' },
...
export const footerSeedDe = {
  ...
  columns: [
    {
      ...
      links: [
        ...
        link('Studio 45', '/rooms'),
        link('Check-in / Check-out', '/policies/check-in', { dividerBefore: true }),
        link('Stornierungen', '/policies/cancellation'),
        link('Haustiere', '/policies/pets'),
      ],
    },
    {
      icon: 'UtensilsCrossed',
  ...
  legalLinks: [
    ...
    { visible: true, label: 'Cookies', url: '/cookies' },
    { visible: true, label: 'Haftungsausschluss', url: '/disclaimer' },
